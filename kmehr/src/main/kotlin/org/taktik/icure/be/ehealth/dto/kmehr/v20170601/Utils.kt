...
package org.taktik.icure.be.ehealth.dto.kmehr.v20170601

import org.taktik.icure.be.ehealth.dto.kmehr.v20131001.Utils
import org.taktik.icure.be.ehealth.dto.kmehr.v20170601.be.fgov.ehealth.standards.kmehr.schema.v1.DateType
import org.taktik.icure.be.ehealth.dto.kmehr.v20170601.be.fgov.ehealth.standards.kmehr.schema.v1.MomentType
...
object Utils {
    ...
    fun makeFuzzyLongFromMomentType(moment: org.taktik.icure.services.external.rest.v1.dto.be.ehealth.kmehr.v20170601.be.fgov.ehealth.standards.kmehr.schema.v1.MomentType): Long? {
        if (moment.year != null) {
