...
abstract class AbstractEntityMapper<ICURE_TYPE : Any, SDK_TYPE : Any, DTO_TYPE>(
	...
	private val domainToDto: suspend (ICURE_TYPE) -> DTO_TYPE,
	private val dtoToDomain: suspend (DTO_TYPE) -> ICURE_TYPE
) {

	@JvmName("mapIcureTypeToSdkType")
	@OptIn(InternalSerializationApi::class)
	suspend fun map(entity: ICURE_TYPE): SDK_TYPE = Serialization.json.decodeFromString(
	...
	@OptIn(InternalSerializationApi::class)
	suspend fun map(entity: SDK_TYPE): ICURE_TYPE = objectMapper.readValue(
