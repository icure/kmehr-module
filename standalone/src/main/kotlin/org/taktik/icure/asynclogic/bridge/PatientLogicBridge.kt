...
class PatientLogicBridge(
    ...
    override fun findByHcPartyAndIdentifier(
        ...
        system: String,
        id: String,
    ): Flow<Patient> = throw BridgeException()

    override fun findByHcPartyAndSsin(
        ssin: String?,
        healthcarePartyId: String,
        paginationOffset: PaginationOffset<List<String>>,
    ): Flow<ViewQueryResultEvent> = throw BridgeException()
    ...
    override suspend fun findByUserId(id: String): Patient? = throw BridgeException()
    ...
    ): Flow<PaginationElement> = throw BridgeException()
    ...
    override suspend fun getByExternalId(externalId: String): Patient? = throw BridgeException()
    ...
    override fun listOfMergesAfter(date: Long?): Flow<Patient> = throw BridgeException()
    ...
    override suspend fun modifyPatient(patient: Patient): Patient? = throw BridgeException()
    ...
    override fun modifyPatients(patients: Collection<Patient>): Flow<Patient> = throw BridgeException()

    override fun matchEntitiesBy(filter: AbstractFilter<*>): Flow<String> =
        flow {
