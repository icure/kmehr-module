...
interface AmpDAO : InternalDAO<Amp> {
    ...
    fun findAmpsByVmpGroupCode(
        datastoreInformation: IDatastoreInformation,
        vmpgCode: String,
        paginationOffset: PaginationOffset<String>,
    ): Flow<ViewQueryResultEvent>

    fun findAmpsByVmpGroupId(
        datastoreInformation: IDatastoreInformation,
        vmpgId: String,
        paginationOffset: PaginationOffset<String>,
    ): Flow<ViewQueryResultEvent>

    fun findAmpsByVmpCode(
        datastoreInformation: IDatastoreInformation,
        vmpCode: String,
        paginationOffset: PaginationOffset<String>,
    ): Flow<ViewQueryResultEvent>
    ...
    fun findAmpsByChapterParagraph(
        datastoreInformation: IDatastoreInformation,
        chapter: String,
        paragraph: String,
    ...
    fun listAmpIdsByVmpGroupId(
        datastoreInformation: IDatastoreInformation,
        vmpgId: String,
    ): Flow<String>

    fun listAmpIdsByVmpCode(
        datastoreInformation: IDatastoreInformation,
        vmpCode: String,
    ): Flow<String>

    fun listAmpIdsByVmpId(
        datastoreInformation: IDatastoreInformation,
        vmpId: String,
    ): Flow<String>

    fun listAmpsByVmpGroupCodes(
        datastoreInformation: IDatastoreInformation,
    ...
    fun listAmpsByDmppCodes(
        datastoreInformation: IDatastoreInformation,
        dmppCodes: List<String>,
    ): Flow<Amp>

    fun listAmpsByVmpGroupIds(
        datastoreInformation: IDatastoreInformation,
        vmpGroupIds: List<String>,
    ): Flow<Amp>
    ...
    suspend fun getProductIdsFromSignature(
        datastoreInformation: IDatastoreInformation,
        type: String,
    ): Map<String, String>
