...
class SamV2LogicImpl(
	...
	override fun findVmpsByGroupId(vmpgId: String, paginationOffset: PaginationOffset<String>): Flow<PaginationElement> = flow {
	...
	override fun findVmpsByGroupCode(vmpgCode: String, paginationOffset: PaginationOffset<String>): Flow<PaginationElement> = flow {
		val datastore = datastoreInstanceProvider.getInstanceAndGroup()
		emitAll(vmpDAO
	...
	override fun findVmpsByLabel(language: String?, label: String?, paginationOffset: PaginationOffset<List<String>>): Flow<PaginationElement> = flow {
		val datastore = datastoreInstanceProvider.getInstanceAndGroup()
		emitAll(vmpDAO
	...
	override fun findVmpsByVmpCode(vmpCode: String, paginationOffset: PaginationOffset<String>): Flow<PaginationElement> = flow {
		val datastore = datastoreInstanceProvider.getInstanceAndGroup()
		emitAll(vmpDAO
	...
	override fun getVtmNamesForParagraph(chapterName: String, paragraphName: String, language: String): Flow<String> {
		return getAmpsForParagraph(chapterName, paragraphName).bufferedChunks(100, 200).flatMapConcat { amp ->
