...
interface SamV2Logic {
	fun findAmpsByLabel(language: String?, label: String, paginationOffset: PaginationOffset<Nothing>): Flow<Amp>
	...
	fun findVmpsByVmpCode(vmpCode: String, paginationOffset: PaginationOffset<String>): Flow<PaginationElement>
	fun findVmpsByGroupCode(vmpgCode: String, paginationOffset: PaginationOffset<String>): Flow<PaginationElement>
	fun findVmpsByGroupId(vmpgId: String, paginationOffset: PaginationOffset<String>): Flow<PaginationElement>
