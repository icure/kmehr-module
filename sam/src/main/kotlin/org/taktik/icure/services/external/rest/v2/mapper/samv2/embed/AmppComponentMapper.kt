...
@Mapper(componentModel = "spring", uses = [PackagingTypeV2Mapper::class, DeviceTypeV2Mapper::class, SamTextV2Mapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
