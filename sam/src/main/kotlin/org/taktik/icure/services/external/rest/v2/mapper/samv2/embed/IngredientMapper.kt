...
@Mapper(componentModel = "spring", uses = [QuantityV2Mapper::class, SubstanceStubV2Mapper::class, ComplexStrengthV2Mapper::class, SamTextV2Mapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
