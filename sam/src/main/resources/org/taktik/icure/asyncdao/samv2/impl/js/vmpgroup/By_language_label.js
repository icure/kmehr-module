map = function(doc) {
    ...
    if (doc.java_type === 'org.taktik.icure.entities.samv2.VmpGroup' && !doc.deleted) {
        ...
        Object.keys(doc.name).forEach(function (l) {
            wordsPerLanguage[l] = []
            if (doc.name[l]) {
                wordsPerLanguage[l] = wordsPerLanguage[l].concat(normalize_substrings(doc.name[l], latin_map))
            }
        })
