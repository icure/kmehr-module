    ...
    extends DosageParameterKeyType
{
    ...
    @XmlElement(name = "Definition", namespace = "urn:be:fgov:ehealth:samws:v2:refdata", required = true)
    protected Text255Type definition;
    @XmlElement(name = "StandardUnit", namespace = "urn:be:fgov:ehealth:samws:v2:refdata", required = true)
    protected String standardUnit;
    @XmlElement(name = "SnomedCT", namespace = "urn:be:fgov:ehealth:samws:v2:refdata", required = true)
