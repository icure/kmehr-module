...
@XmlType(name = "RemoveCompoundingIngredientRequestType", propOrder = {
    "compoundingIngredients"
})
@XmlRootElement(name = "RemoveCompoundingIngredientRequest")
public class RemoveCompoundingIngredientRequest
    implements Serializable
{

    private final static long serialVersionUID = 2L;
    @XmlElement(name = "CompoundingIngredient", required = true)
    protected List<RemoveCompoundingIngredientType> compoundingIngredients;
     ...
     *
     */
    public List<RemoveCompoundingIngredientType> getCompoundingIngredients() {
        if (compoundingIngredients == null) {
            compoundingIngredients = new ArrayList<RemoveCompoundingIngredientType>();
        }
