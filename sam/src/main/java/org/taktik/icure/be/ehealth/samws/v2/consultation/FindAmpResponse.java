...
/**
 * <p>Java class for FindAmpResponseType complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="FindAmpResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;choice>
 *         &lt;element name="Amp" type="{urn:be:fgov:ehealth:samws:v2:consultation}ConsultAmpType" maxOccurs="unbounded"/>
...
@XmlType(name = "FindAmpResponseType", propOrder = {
    "anomalies",
    "amps"
})
@XmlRootElement(name = "FindAmpResponse")
public class FindAmpResponse
    implements Serializable
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the amps property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<ConsultAmpType> getAmps() {
        if (amps == null) {
            amps = new ArrayList<ConsultAmpType>();
        }
        return this.amps;
    }
