 ...
 *       &lt;sequence>
 *         &lt;element name="Price" type="{urn:be:fgov:ehealth:samws:v2:core}Decimal20d4Type"/>
 *       &lt;/sequence>
    ...
    extends DmppKeyType
{
    ...
    @XmlElement(name = "Price", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common", required = true)
