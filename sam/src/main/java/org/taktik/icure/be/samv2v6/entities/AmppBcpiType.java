...
@XmlType(name = "AmppBcpiType", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common", propOrder = {
    "singleUse",
    "speciallyRegulated",
    "abbreviatedName",
    "prescriptionName",
    ...
    extends AmppKeyType
{
    ...
    @XmlElement(name = "NoGenericPrescriptionReasonCode", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
