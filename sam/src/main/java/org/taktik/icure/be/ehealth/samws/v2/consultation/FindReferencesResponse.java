    ...
    implements Serializable
{
    ...
    public List<DeliveryModus> getDeliveryModuses() {
        if (deliveryModuses == null) {
            deliveryModuses = new ArrayList<DeliveryModus>();
        }
    ...
    public List<PackagingMaterial> getPackagingMaterials() {
        if (packagingMaterials == null) {
            packagingMaterials = new ArrayList<PackagingMaterial>();
        }
    ...
    public List<RouteOfAdministration> getRouteOfAdministrations() {
        if (routeOfAdministrations == null) {
            routeOfAdministrations = new ArrayList<RouteOfAdministration>();
        }
    ...
    public List<NoSwitchReason> getNoSwitchReasons() {
        if (noSwitchReasons == null) {
            noSwitchReasons = new ArrayList<NoSwitchReason>();
        }
    ...
    public List<VirtualForm> getVirtualForms() {
        if (virtualForms == null) {
            virtualForms = new ArrayList<VirtualForm>();
        }
    ...
    public List<FormCategory> getFormCategories() {
        if (formCategories == null) {
            formCategories = new ArrayList<FormCategory>();
        }
