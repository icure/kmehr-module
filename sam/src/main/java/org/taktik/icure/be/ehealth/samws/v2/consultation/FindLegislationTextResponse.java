...
/**
 * <p>Java class for FindLegislationTextResponseType complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="FindLegislationTextResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;choice>
 *         &lt;element name="LegalBasis" type="{urn:be:fgov:ehealth:samws:v2:consultation}ConsultLegalBasisType" maxOccurs="unbounded"/>
...
@XmlType(name = "FindLegislationTextResponseType", propOrder = {
    "anomalies",
    "legalbases"
})
@XmlRootElement(name = "FindLegislationTextResponse")
public class FindLegislationTextResponse
    implements Serializable
{
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ConsultLegalBasisType }
     *
     *
     */
    public List<ConsultLegalBasisType> getLegalbases() {
        if (legalbases == null) {
            legalbases = new ArrayList<ConsultLegalBasisType>();
        }
