    ...
    extends AmppFamhpType
{
    ...
    @XmlElement(name = "AmppComponent", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common", required = true)
    protected List<AddAmppComponentType> amppComponent;
    @XmlElement(name = "Commercialization", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
