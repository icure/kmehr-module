...
/**
 * <p>Java class for FindReimbursementResponseType complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="FindReimbursementResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;choice>
 *         &lt;element name="ReimbursementContexts" type="{urn:be:fgov:ehealth:samws:v2:consultation}ConsultReimbursementContextType" maxOccurs="unbounded"/>
...
@XmlType(name = "FindReimbursementResponseType", propOrder = {
    "anomalies",
    "reimbursementContexts"
})
@XmlRootElement(name = "FindReimbursementResponse")
public class FindReimbursementResponse
    implements Serializable
{
    ...
    @XmlElement(name = "ReimbursementContexts")
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ConsultReimbursementContextType }
     *
     *
     */
    public List<ConsultReimbursementContextType> getReimbursementContexts() {
        if (reimbursementContexts == null) {
            reimbursementContexts = new ArrayList<ConsultReimbursementContextType>();
        }
