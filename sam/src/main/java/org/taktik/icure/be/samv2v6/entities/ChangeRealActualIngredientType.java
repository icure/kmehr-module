    ...
    extends RealActualIngredientKeyType
{
    ...
    @XmlElement(name = "Type", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    ...
    @XmlElement(name = "SubstanceCode", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    protected String substanceCode;
    @XmlElement(name = "RealActualIngredientEquivalent", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
