...
/**
 * <p>Java class for ReimbursedImportedMedicinalProductPackageType complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="ReimbursedImportedMedicinalProductPackageType">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{urn:be:fgov:ehealth:samws:v2:actual:imported}ReimbursedImportedMedicinalProductPackageReferences"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReimbursedImportedMedicinalProductPackageType", namespace = "urn:be:fgov:ehealth:samws:v2:actual:imported", propOrder = {
    "pricingUnitQuantity",
    "pricingUnitLabel",
    "legalText",
    "addedDocument",
...
public class ReimbursedImportedMedicinalProductPackageType
    extends ReimbursedImportedMedicinalProductPackageKeyType
{
    ...
    @XmlElement(name = "ReimbursementCriterionCategory", namespace = "urn:be:fgov:ehealth:samws:v2:actual:imported", required = true)
    protected String reimbursementCriterionCategory;
    @XmlElement(name = "ReimbursementCriterionCode", namespace = "urn:be:fgov:ehealth:samws:v2:actual:imported", required = true)
