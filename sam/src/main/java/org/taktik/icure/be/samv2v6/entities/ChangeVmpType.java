    ...
    extends VmpKeyType
{
    ...
    @XmlElement(name = "Abbreviation", namespace = "urn:be:fgov:ehealth:samws:v2:virtual:common")
    ...
    @XmlElement(name = "VmpComponent", namespace = "urn:be:fgov:ehealth:samws:v2:virtual:common")
