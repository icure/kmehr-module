    ...
    extends AmpKeyType
{
    ...
    @XmlElement(name = "OfficialName", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    ...
    @XmlElement(name = "MedicineType", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    @XmlSchemaType(name = "string")
    ...
    @XmlElement(name = "CompanyActorNr", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    protected String companyActorNr;
    @XmlElement(name = "AmpComponent", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    protected List<ChangeAmpComponentFamhpType> ampComponent;
    @XmlElement(name = "Ampp", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
