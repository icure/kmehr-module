...
/**
 * <p>Java class for FindVmpResponseType complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="FindVmpResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;choice>
 *         &lt;element name="Vmp" type="{urn:be:fgov:ehealth:samws:v2:consultation}ConsultVmpType" maxOccurs="unbounded"/>
...
@XmlType(name = "FindVmpResponseType", propOrder = {
    "anomalies",
    "vmps"
})
@XmlRootElement(name = "FindVmpResponse")
public class FindVmpResponse
    implements Serializable
{
    ...
    public List<ConsultVmpType> getVmps() {
        if (vmps == null) {
            vmps = new ArrayList<ConsultVmpType>();
        }
        return this.vmps;
    }
