...
@XmlType(name = "RemoveCommentedClassificationType", namespace = "urn:be:fgov:ehealth:samws:v2:virtual:common", propOrder = {
    ...
    extends CommentedClassificationKeyType
{
    ...
    @XmlElement(name = "CommentedClassification", namespace = "urn:be:fgov:ehealth:samws:v2:virtual:common")
    protected List<RemoveCommentedClassificationType> commentedClassification;
     ...
     *
     */
    public List<RemoveCommentedClassificationType> getCommentedClassification() {
        if (commentedClassification == null) {
            commentedClassification = new ArrayList<RemoveCommentedClassificationType>();
        }
