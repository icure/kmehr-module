 ...
 *       &lt;sequence>
 *         &lt;element name="Data" type="{urn:be:fgov:ehealth:samws:v2:export}NameExplanationDataType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "NameExplanationFullDataType", namespace = "urn:be:fgov:ehealth:samws:v2:export", propOrder = {
    "data",
    "nameTranslation"
})
    ...
    extends NameExplanationKeyType
{
    ...
    @XmlElement(name = "NameTranslation", namespace = "urn:be:fgov:ehealth:samws:v2:export")
