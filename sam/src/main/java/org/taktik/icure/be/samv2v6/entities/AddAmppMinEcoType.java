 ...
 *       &lt;sequence>
 *         &lt;element name="ExFactoryPrice" type="{urn:be:fgov:ehealth:samws:v2:core}Decimal20d4Type"/>
 *         &lt;element name="RealExFactoryPrice" type="{urn:be:fgov:ehealth:samws:v2:core}Decimal20d4Type" minOccurs="0"/>
 *         &lt;element name="DecisionDate" type="{http://www.w3.org/2001/XMLSchema}date"/>
 *         &lt;element name="Index" type="{urn:be:fgov:ehealth:samws:v2:core}Decimal20d4Type" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    extends AmppKeyType
{
    ...
    @XmlElement(name = "ExFactoryPrice", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common", required = true)
    ...
    @XmlElement(name = "DecisionDate", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common", required = true)
