    ...
    extends VmpGroupKeyType
{
    ...
    @XmlElement(name = "NoGenericPrescriptionReasonCode", namespace = "urn:be:fgov:ehealth:samws:v2:virtual:common")
    protected String noGenericPrescriptionReasonCode;
    @XmlElement(name = "NoSwitchReasonCode", namespace = "urn:be:fgov:ehealth:samws:v2:virtual:common")
    protected String noSwitchReasonCode;
    @XmlElement(name = "StandardDosageCode", namespace = "urn:be:fgov:ehealth:samws:v2:virtual:common")
