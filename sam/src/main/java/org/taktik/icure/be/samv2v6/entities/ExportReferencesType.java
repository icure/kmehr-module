    ...
    extends VersionedExportType
{
    ...
    @XmlElement(name = "AdministrationUnit", namespace = "urn:be:fgov:ehealth:samws:v2:refdata")
    protected List<AdministrationUnitType> administrationUnit;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the administrationUnit property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAdministrationUnit().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     *
     */
    public List<AdministrationUnitType> getAdministrationUnit() {
        if (administrationUnit == null) {
            administrationUnit = new ArrayList<AdministrationUnitType>();
        }
