...
@XmlType(name = "StandardResponseType", namespace = "urn:be:fgov:ehealth:samws:v2:core", propOrder = {
    "anomaly"
})
public class StandardResponseType {

    @XmlElement(name = "Anomaly", namespace = "urn:be:fgov:ehealth:samws:v2:core")
