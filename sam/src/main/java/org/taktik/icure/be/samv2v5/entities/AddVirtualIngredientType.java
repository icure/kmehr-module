...
@XmlType(name = "AddVirtualIngredientType", namespace = "urn:be:fgov:ehealth:samws:v2:virtual:common", propOrder = {
    ...
    extends VirtualIngredientType
{
    ...
    protected List<AddRealVirtualIngredientType> realVirtualIngredient;
     ...
     *
     */
    public List<AddRealVirtualIngredientType> getRealVirtualIngredient() {
        if (realVirtualIngredient == null) {
            realVirtualIngredient = new ArrayList<AddRealVirtualIngredientType>();
        }
