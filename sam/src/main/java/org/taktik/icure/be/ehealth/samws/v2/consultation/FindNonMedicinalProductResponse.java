...
/**
 * <p>Java class for FindNonMedicinalProductResponseType complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="FindNonMedicinalProductResponseType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;choice>
 *         &lt;element name="NonMedicinalProduct" type="{urn:be:fgov:ehealth:samws:v2:consultation}ConsultNonMedicinalProductType" maxOccurs="unbounded"/>
...
@XmlType(name = "FindNonMedicinalProductResponseType", propOrder = {
    "anomalies",
    "nonMedicinalProducts"
})
@XmlRootElement(name = "FindNonMedicinalProductResponse")
public class FindNonMedicinalProductResponse
    implements Serializable
{
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ConsultNonMedicinalProductType }
     *
     *
     */
    public List<ConsultNonMedicinalProductType> getNonMedicinalProducts() {
        if (nonMedicinalProducts == null) {
            nonMedicinalProducts = new ArrayList<ConsultNonMedicinalProductType>();
        }
