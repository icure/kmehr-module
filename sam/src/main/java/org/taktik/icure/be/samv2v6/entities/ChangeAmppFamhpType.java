    ...
    extends AmppKeyType
{
    ...
    @XmlElement(name = "AuthorisationNr", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    ...
    @XmlElement(name = "DeliveryModusCode", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    ...
    @XmlElement(name = "AmppComponent", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    protected List<ChangeAmppComponentType> amppComponent;
    @XmlElement(name = "SupplyProblem", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
    protected ChangeSupplyProblemType supplyProblem;
    @XmlElement(name = "DerogationImport", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common")
