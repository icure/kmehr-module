 ...
 *         &lt;element name="StandardDosage" type="{urn:be:fgov:ehealth:samws:v2:export}StandardDosageFullDataType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends VersionedExportType
{
    ...
    protected List<StandardDosageFullDataType> standardDosage;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StandardDosageFullDataType }
     *
     *
     */
    public List<StandardDosageFullDataType> getStandardDosage() {
        if (standardDosage == null) {
            standardDosage = new ArrayList<StandardDosageFullDataType>();
        }
