    ...
    extends RouteOfAdministrationType
{
    ...
    protected List<ExportStandardRouteType> standardRoute;
     ...
     *
     */
    public List<ExportStandardRouteType> getStandardRoute() {
        if (standardRoute == null) {
            standardRoute = new ArrayList<ExportStandardRouteType>();
        }
