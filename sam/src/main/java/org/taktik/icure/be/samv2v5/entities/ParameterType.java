    ...
    extends ParameterKeyType
{
    ...
    @XmlElement(name = "UnitType", namespace = "urn:be:fgov:ehealth:samws:v2:refdata", required = true)
    @XmlSchemaType(name = "string")
    protected UnitTypeType unitType;
    @XmlElement(name = "Domain", namespace = "urn:be:fgov:ehealth:samws:v2:refdata")
