...
public class ExportNonMedicinalType
    extends VersionedExportType
{

    @XmlElement(name = "NonMedicinalProduct")
    protected List<NonMedicinalProductFullDataType> nonMedicinalProduct;
     ...
     *
     */
    public List<NonMedicinalProductFullDataType> getNonMedicinalProduct() {
        if (nonMedicinalProduct == null) {
            nonMedicinalProduct = new ArrayList<NonMedicinalProductFullDataType>();
        }
