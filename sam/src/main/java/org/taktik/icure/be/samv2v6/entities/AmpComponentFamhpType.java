    ...
    extends AmpComponentKeyType
{
    ...
    @XmlElement(name = "PharmaceuticalFormCode", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common", required = true)
    protected List<String> pharmaceuticalFormCode;
    @XmlElement(name = "RouteOfAdministrationCode", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common", required = true)
    protected List<String> routeOfAdministrationCode;
    @XmlElement(name = "RealActualIngredient", namespace = "urn:be:fgov:ehealth:samws:v2:actual:common", required = true)
