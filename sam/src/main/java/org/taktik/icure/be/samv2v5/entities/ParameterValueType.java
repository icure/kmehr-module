...
public class ParameterValueType {
    ...
    @XmlElement(name = "Quantity", namespace = "urn:be:fgov:ehealth:samws:v2:reimbursementlaw:submit")
    protected QuantityType quantity;
    @XmlElement(name = "QuantityRange", namespace = "urn:be:fgov:ehealth:samws:v2:reimbursementlaw:submit")
    protected RangeType quantityRange;
    @XmlElement(name = "Strength", namespace = "urn:be:fgov:ehealth:samws:v2:reimbursementlaw:submit")
    protected StrengthType strength;
    @XmlElement(name = "StrengthRange", namespace = "urn:be:fgov:ehealth:samws:v2:reimbursementlaw:submit")
    protected StrengthRangeType strengthRange;
    @XmlElement(name = "Code", namespace = "urn:be:fgov:ehealth:samws:v2:reimbursementlaw:submit")
    protected String code;
    @XmlElement(name = "Boolean", namespace = "urn:be:fgov:ehealth:samws:v2:reimbursementlaw:submit")
