...
public class LegalReferencePathToParagraphType {
    ...
    @XmlElement(name = "ChapterName", namespace = "urn:be:fgov:ehealth:samws:v2:refdata", required = true)
    protected String chapterName;
    @XmlElement(name = "ParagraphName", namespace = "urn:be:fgov:ehealth:samws:v2:refdata", required = true)
