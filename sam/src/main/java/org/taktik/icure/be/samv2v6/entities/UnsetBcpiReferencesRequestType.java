...
public class UnsetBcpiReferencesRequestType {
    ...
    protected List<AdministrationUnitKeyType> administrationUnit;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdministrationUnitKeyType }
     *
     *
     */
    public List<AdministrationUnitKeyType> getAdministrationUnit() {
        if (administrationUnit == null) {
            administrationUnit = new ArrayList<AdministrationUnitKeyType>();
        }
