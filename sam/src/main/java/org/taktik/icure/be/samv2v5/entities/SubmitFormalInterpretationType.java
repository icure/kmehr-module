    ...
    extends FormalInterpretationType
{
    ...
    @XmlElement(name = "ReimbursementCondition", namespace = "urn:be:fgov:ehealth:samws:v2:reimbursementlaw:submit")
    protected List<SubmitReimbursementConditionType> reimbursementCondition;
    @XmlElement(name = "ReimbursementTerm", namespace = "urn:be:fgov:ehealth:samws:v2:reimbursementlaw:submit")
